...
export declare type NotificationEventName =
  | 'click'
  | 'foregroundWillDisplay'
  | 'dismiss'
  | 'permissionChange'
  | 'permissionPromptDisplay';
export declare type SlidedownEventName =
  | 'slidedownAllowClick'
  | 'slidedownCancelClick'
  | 'slidedownClosed'
  | 'slidedownQueued'
  | 'slidedownShown';
export declare type OneSignalDeferredLoadedCallback = (
